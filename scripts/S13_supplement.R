...
source("code/setup.R")
setup_packages(c(
  "ggplot2", "grid", "gridExtra", "patchwork", "popbio",
...
p1 <- ggplot(sigma_sim, aes(sigma)) +
  ...
  labs(
    x = "Stage-specific survival probability",
    y = "Density"
  ) +
  tt
